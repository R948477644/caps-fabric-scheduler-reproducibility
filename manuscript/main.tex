...
\begin{sloppypar}
The source code, experimental configurations, raw and processed measurements, plotting scripts, and manuscript artifacts are available in the public GitHub release at \url{https://github.com/R948477644/caps-fabric-scheduler-reproducibility/releases/tag/v1.0.0-peerj-submission}. The archived version used for this manuscript is available on Zenodo at \url{https://doi.org/10.5281/zenodo.21211955}.
\end{sloppypar}
