...
VERSION="${FABRIC_CHAINCODE_VERSION:-1.2-default}"
SEQUENCE="${FABRIC_CHAINCODE_SEQUENCE:-5}"
...
echo "Approving ${CC_NAME} sequence ${SEQUENCE} default channel endorsement for Org1MSP"
set_org1
approve_current_org

echo "Approving ${CC_NAME} sequence ${SEQUENCE} default channel endorsement for Org2MSP"
set_org2
approve_current_org
