...
const config = {
    port: Number(process.env.PACC_LPAAC_DISPATCHER_PORT || 8087),
...
class VllScdDispatcher {
    ...
    async runTask(task) {
        ...
        try {
            ...
            sendJson(task.res, 200, { ok: true, scheduler: 'pacc-lpaac', queueWaitMs, fabricMs, totalMs });
        } catch (err) {
